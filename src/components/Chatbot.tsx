...
export function Chatbot() {
  ...
  // Tooltip promozionale: appare brevemente e si nasconde da solo (non copre i contenuti)
  ...
  return (
    <>
      ...
      >
        {/* Tooltip — solo brevemente all'avvio, poi si nasconde (no overlap contenuti) */}
        <AnimatePresence>
          {showTip && (
            <motion.div
              ...
              className="bg-zinc-900 border border-white/10 rounded-xl px-3 py-2 shadow-xl backdrop-blur-sm mr-1"
            >
              <p className="text-[11px] font-bold text-white whitespace-nowrap">Chiedi ad Amerigo</p>
