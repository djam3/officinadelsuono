    ...
    <div className="min-h-screen bg-zinc-950 text-white flex">
      ...
      <main className="flex-1 min-w-0 flex flex-col">
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <button onClick={() => setActiveTab('products')} className="p-4 bg-zinc-900 hover:bg-zinc-800 border border-white/5 hover:border-brand-orange/30 rounded-xl text-left transition-all group">
                  ...
                  <button onClick={() => setActiveTab('blog')} className="p-4 bg-zinc-900 hover:bg-zinc-800 border border-white/5 hover:border-brand-orange/30 rounded-xl text-left transition-all group">
        ...
        {activeTab === 'newsletter' && (
          <AdminNewsletterPanel products={products} />
        )}
        {activeTab === 'blog' && (
          <AdminBlogPanel blogPosts={blogPosts} />
        )}

        {/* ── Tab Codici Sconto ──────────────────────────────────────── */}
        {activeTab === 'discounts' && (
          <AdminDiscountsPanel discounts={discounts} />
        )}
