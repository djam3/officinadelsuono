      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="bg-ink-2 border border-paper/10 rounded-none p-8 md:p-12 shadow-2xl space-y-10">
            ...
            <section>
              <h2 className="text-2xl font-bold text-marker mb-3">1. Identità del venditore</h2>
              <p className="text-paper/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-marker mb-3">2. Prodotti e prezzi</h2>
              <p className="text-paper/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-marker mb-3">3. Conclusione del contratto</h2>
              <p className="text-paper/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-marker mb-3">4. Modalità di pagamento</h2>
              <p className="text-paper/90 leading-relaxed mb-3">Sono accettate le seguenti modalità:</p>
              ...
              <p className="text-graphite text-sm mt-3">I dati delle carte non transitano mai dai nostri server: vengono trattati direttamente dai provider di pagamento certificati PCI-DSS.</p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-marker mb-3">5. Spedizioni e consegna</h2>
              <p className="text-paper/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-marker mb-3">6. Diritto di recesso (artt. 52-59 Codice del Consumo)</h2>
              <p className="text-paper/90 leading-relaxed mb-3">
              ...
              <ol className="list-decimal list-inside space-y-2 text-paper/90 ml-2 mb-3">
                <li>Inviare comunicazione esplicita via email a <a href="mailto:info@officina-del-suono.it" className="text-marker hover:underline">info@officina-del-suono.it</a> o via PEC, indicando numero d'ordine, prodotto e dati personali;</li>
            ...
            <section>
              <h2 className="text-2xl font-bold text-marker mb-3">7. Garanzia legale di conformità</h2>
              <p className="text-paper/90 leading-relaxed">
                Tutti i prodotti sono coperti dalla garanzia legale di conformità prevista dagli artt. 128-135 del Codice del Consumo:
              </p>
              <ul className="list-disc list-inside space-y-2 text-paper/90 ml-2 mt-3">
            ...
            <section>
              <h2 className="text-2xl font-bold text-marker mb-3">8. Responsabilità</h2>
              <p className="text-paper/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-marker mb-3">9. Legge applicabile e foro competente</h2>
              <p className="text-paper/90 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-marker mb-3">10. Risoluzione delle controversie online (ODR)</h2>
              <p className="text-paper/90 leading-relaxed">
                Ai sensi dell'art. 14 del Regolamento (UE) n. 524/2013, informiamo che è possibile risolvere extragiudizialmente le controversie relative agli acquisti online tramite la piattaforma ODR della Commissione Europea: <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-marker hover:underline">https://ec.europa.eu/consumers/odr</a>.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-bold text-marker mb-3">11. Modifiche</h2>
              <p className="text-paper/90 leading-relaxed">
